...
using static StudentDetailsLayers.Business.BusinessLogic;

namespace StudentDetailsLayers
{
    internal class Program
    {
                    ...
                    if (Utility.TryParseEnum(Console.ReadLine(), out EnumValues.MenuChoice choice))
                    {
                        switch (choiceTable)
                        {
                            ...
                            case EnumValues.MenuChoiceTable.Course:
                                ...
                                {
                                    case EnumValues.MenuChoice.Insert:
                                        CourseInsertData(typeof(CourseDetailDTO));
                                        break;
                                    case EnumValues.MenuChoice.Update:
                                        CourseUpdateData();
                                        break;
        ...
        static void StudentInsertData(Type entityType)
        {
            try
            {
                ...
                bool addSuccess = StudentLogic.AddStudent((StudentDTO)entity);
        ...
        static void CourseInsertData(Type entityType)
        {
            try
            {
                ...
                bool addSuccess = CourseLogic.AddCourse((CourseDetailDTO)entity);
        ...
        static void ClassInsertData(Type entityType)
        {
            try
            {
                ...
                bool addSuccess = ClassDetailLogic.AddClass((ClassDetailDTO)entity);
        ...
        static void StudentUpdateData()
        {
            try
            {
                ...
                bool addSuccess = StudentLogic.UpdateStudent(studentID, col, data);
        ...
        static void ClassUpdateData()
        {
            try
            {
                ...
                bool addSuccess = ClassDetailLogic.UpdateClass(classID, col, data);
        ...
        static void StudentDeleteData()
        {
            try
            {
                ...
                bool addSuccess = StudentLogic.DeleteStudent(studentID);
